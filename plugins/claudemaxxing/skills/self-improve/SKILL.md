---
name: self-improve
description: Run exactly one governed, verifier-selected self-improvement round on the claudemaxxing harness. Use when loop-queue has an actionable flaw or the user explicitly requests a harness round; never fabricate work merely because the queue is empty.
---
