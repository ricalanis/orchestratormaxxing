// claudemaxxing — OpenCode done-notification plugin.
...
//
// Source of truth: <repo>/opencode/plugins/claudemaxxing-notify.js;
// install.sh deploys a copy to ~/.config/opencode/plugins/.

export const ClaudemaxxingNotify = async ({ directory, client, $ }) => {
  ...
  const delegatedWorker = process.env.CLAUDEMAXXING_O_DELEGATED === "1"
