#!/usr/bin/env bash
# ─────────────────────────────────────────────────────────────────────────────
# claudemaxxing — monthly DOCTRINE CONTRADICTION AUDIT seeder.
#
# SOURCE OF TRUTH: this file is a TEMPLATE in the repo
# (deploy/claudemaxxing-doctrine-audit.sh). The live copy at
# $HOME/.config/claudemaxxing/claudemaxxing-doctrine-audit.sh is deployed by
...
LOG_DIR="$HOME/.config/claudemaxxing"
